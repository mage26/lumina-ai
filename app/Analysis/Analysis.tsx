...
export default function Analysis({analysis} : {analysis: analysisType}) {
    const compositionScore = analysis.compositionScore * 100;
    ...
    return (
        <Section className="md:w-[63%]" title="IMAGE DIAGNOSTICS">
            ...
            <div className="flex gap-8 items-center flex-col-reverse md:flex-row">
                ...
                <div className="size-40 relative">
                    <Doughnut data={{
                        datasets: [
                            {
                                data: [analysis.compositionScore * 100, 100 - analysis.compositionScore * 100],
            ...
            <p>{analysis.primarySubjects}</p>
            <p className="font-bold text-accent mt-4 mb-2">SPACIAL ANALYSIS</p>
            <p>{analysis.spacialAnalysis}</p>
